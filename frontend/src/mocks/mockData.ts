...
export const mockStudents: Student[] = [
  ...
  ...Array.from({ length: 10 }, (_, i) => ({
    ...
    first_name: ['Aditya', 'Mira', 'Vihaan', 'Aisha', 'Reyansh', 'Navya', 'Advait', 'Kiara', 'Atharv', 'Myra'][i],
    last_name: ['Shah', 'Nair', 'Desai', 'Rao', 'Shetty', 'Pillai', 'Bhat', 'Kaur', 'Pandey', 'Malhotra'][i],
...
export const mockEnrollments: Enrollment[] = mockStudents.flatMap((student) =>
...
export const mockAttendance: Attendance[] = mockStudents.flatMap((student) =>
...
export const mockDashboardStats = {
  ...
  avgGpa: mockStudents.reduce((sum, s) => sum + s.avg_gpa, 0) / mockStudents.length,
  avgAttendance: mockStudents.reduce((sum, s) => sum + s.avg_attendance, 0) / mockStudents.length,
};
